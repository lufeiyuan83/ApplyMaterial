...
{
    public class Log : IDAL.ApplyMaterial.ILog
    {
        ...
        /// <returns>Log</returns>
        public Model.ApplyMaterial.Log Select(long m_ID)
        {
            using (DataAccess da = new DataAccess())
            {
                ...
                if (dr != null)
                {
                    Model.ApplyMaterial.Log log = new Model.ApplyMaterial.Log();
        ...
        /// <returns>Log</returns>
        public Model.ApplyMaterial.Log Select(string m_Type, string m_ComputerName)
        {
            using (DataAccess da = new DataAccess())
            {
                da.sqlParameters.Clear();
        ...
        public bool Add(Model.ApplyMaterial.Log m_Log)
        {
            using (DataAccess da = new DataAccess())
            {
                da.sqlParameters.Clear();
        ...
        public bool Save(Model.ApplyMaterial.Log m_Log)
        {
            using (DataAccess da = new DataAccess())
            {
