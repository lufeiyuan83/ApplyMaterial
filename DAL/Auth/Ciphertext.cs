...
namespace DAL.Auth
{
    public class Ciphertext : IDAL.Auth.ICiphertext
    {
        private const string tableName = "Auth.dbo.Ciphertext";
        /// <summary>
        /// 查询单条Ciphertext
        /// </summary>
        ...
        public Model.Auth.Ciphertext Select(string m_SystemName, string m_Cryptograph)
        {
        ...
        public bool Add(Model.Auth.Ciphertext m_Ciphertext)
        {
            using (DataAccess da = new DataAccess())
            {
                da.sqlParameters.Clear();
