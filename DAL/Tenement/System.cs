...
{
    public class System : IDAL.Tenement.ISystem
    {
        private const string tableName = "Tenement.dbo.System";
        ...
        /// <returns>System</returns>
        public Model.Tenement.System Select(long m_Id)
        {
            using (DataAccess da = new DataAccess())
            {
                ...
                if (dr != null)
                {
                    Model.Tenement.System system = new Model.Tenement.System();
        ...
        /// <returns>System</returns>
        public Model.Tenement.System Select(string m_SystemCode)
        {
            using (DataAccess da = new DataAccess())
            {
                da.sqlParameters.Clear();
        ...
        /// <returns>System</returns>
        public Model.Tenement.System Select(string m_SystemCode, string m_SystemName)
        {
            using (DataAccess da = new DataAccess())
            {
                da.sqlParameters.Clear();
        ...
        public bool Add(Model.Tenement.System m_System)
        {
            using (DataAccess da = new DataAccess())
            {
                da.sqlParameters.Clear();
        ...
        public bool Update(Model.Tenement.System m_System)
        {
            using (DataAccess da = new DataAccess())
            {
                da.sqlParameters.Clear();
