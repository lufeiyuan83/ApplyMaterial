...
namespace ERP.Redis
{
    public static class RedisHelper
    {
        ...
        //第一步，连接Reids服务 RedisHelper.SetCon("127.0.0.1:6379,password=FIS232311109Qq,DefaultDatabase=0");
        //第一步，设置键值信息 RedisHelper.Set(Key, Value, int.Parse(expireMinutes));//键,值,过期时间
        //第一步，读取信息  if (RedisHelper.Exists(Key)) Value = RedisHelper.Get(Key).ToString();
