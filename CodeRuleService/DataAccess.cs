...
namespace CodeRuleService
{
    public class DataAccess : IDisposable
    {
        ...
        private readonly string strOperator = "DataAccess";
        ...
        public DataAccess()
        {
            //connectionString = @"Data Source=10.148.15.80;Initial Catalog=PLM;Persist Security Info=True;User ID=sa;Password=FIS232311109Qq";
            connectionString = @"Data Source=.;Initial Catalog=PLM;Persist Security Info=True;User ID=sa;Password=FIS232311109Qq";
        ...
        protected void Open()
        {
            ...
            {
                WriteLog(ex, "Open()|State=" + this.sqlConnection.State.ToString(), strOperator);
            }
        }
        /// <summary>
        /// 关闭连接
        ...
        public void BeginTransaction()
        {
            ...
            {
                WriteLog(ex, "BeginTransaction()", strOperator);
            }
        }
        /// <summary>
        /// 提交事务
        ...
        public void CommitTransaction()
        {
            ...
            {
                WriteLog(ex, "CommitTransaction()", strOperator);
            }
        }
        /// <summary>
        /// 回滚事务
        ...
        public void RollbackTransaction()
        {
            ...
            {
                WriteLog(ex, "RollbackTransaction()", strOperator);
            }          
        }
        /// <summary>
        /// 创建一个Sql参数
        ...
        public int ExecuteCommand(string commandText)
        {
            ...
            {
                WriteLog(ex, "ExecuteCommand(commandText=" + commandText + ")", strOperator);
                throw;
            }
            finally
            {
        ...
        public int ExecuteCommand(string commandText, IList<SqlParameter> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                WriteLog(ex, "ExecuteCommand(commandText=" + commandText + ",parameters=" + strParameters + ")", strOperator);
                throw;
            }
            finally
            {
        ...
        public bool ExecuteTransact(IList<string> commandTexts)
        {
            ...
            catch (Exception ex)
            {
                ...
                WriteLog(ex, "ExecuteTransact(commandTexts=" + strCommandTexts + ")", strOperator);
                return false;
            }
            finally
            {
        ...
        public int ExecuteTransact(string storedProcedureName)
        {
            ...
            {
                WriteLog(ex, "ExecuteTransact(storedProcedureName=" + storedProcedureName + ")", strOperator);
                return 0;
            }
        }
        /// <summary>
        ...
        public int ExecuteTransact(string storedProcedureName, IList<SqlParameter> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                WriteLog(ex, "ExecuteTransact(storedProcedureName=" + storedProcedureName + ",parameters=" + strParameters + ")", strOperator);
                return 0;
            }
        }
        /// <summary>
        ...
        public SqlDataReader ExecuteReader(string commandText)
        {
            ...
            {
                WriteLog(ex, "ExecuteReader(commandText=" + commandText + ")", strOperator);
                return null;
            }
        }
        /// <summary>
        ...
        public SqlDataReader ExecuteReader(string commandText, IList<SqlParameter> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                WriteLog(ex, "ExecuteReader(commandText=" + commandText + ",parameters=" + strParameters + ")", strOperator);
                return null;
            }
            finally
            {
        ...
        public DataTable GetDataTable(string commandText)
        {
            if (!string.IsNullOrEmpty(commandText))
            {
                ...
                {
                    WriteLog(ex, "GetDataTable(commandText=" + commandText + ")", strOperator);
                    return null;
                }
                finally
                {
        ...
        public DataTable GetDataTable(string commandText, IList<SqlParameter> parameters)
        {
            if (!string.IsNullOrEmpty(commandText))
            {
                ...
                catch (Exception ex)
                {
                    ...
                    WriteLog(ex, "GetDataTable(commandText=" + commandText + ",parameters=" + strParameters + ")", strOperator);
                    return null;
                }
            }
            else
        ...
        public DataSet GetDataSet(string commandText)
        {
            if (!string.IsNullOrEmpty(commandText))
            {
                ...
                {
                    WriteLog(ex, "GetDataSet(commandText=" + commandText + ")", strOperator);
                    return null;
                }
            }
            else
        ...
        public DataSet GetDataSet(string commandText, IList<SqlParameter> parameters)
        {
            if (!string.IsNullOrEmpty(commandText))
            {
                ...
                catch (Exception ex)
                {
                    ...
                    WriteLog(ex, "GetDataSet(commandText=" + commandText + ",parameters=" + strParameters + ")", strOperator);
                    return null;
                }
            }
            else
        ...
        public object GetScalar(string commandText)
        {
            if (!string.IsNullOrEmpty(commandText))
            {
                ...
                {
                    WriteLog(ex, "GetScalar(commandText=" + commandText + ")", strOperator);
                    return null;
                }
            }
            else
        ...
        public object GetScalar(string commandText, IList<SqlParameter> parameters)
        {
            if (!string.IsNullOrEmpty(commandText))
            {
                ...
                catch (Exception ex)
                {
                    ...
                    WriteLog(ex, "GetScalar(commandText=" + commandText + ",parameters=" + strParameters + ")", strOperator);
                    return null;
                }
            }
            else
        ...
        public Dictionary<object, object> GetKeyValues(string commandText)
        {
            if (!string.IsNullOrEmpty(commandText))
            {
                ...
                {
                    WriteLog(ex, "GetKeyValues(commandText=" + commandText + ")", strOperator);
                    return null;
                }
            }
            else
        ...
        public Dictionary<object, object> GetKeyValues(string commandText, IList<SqlParameter> parameters)
        {
            if (!string.IsNullOrEmpty(commandText))
            {
                ...
                catch (Exception ex)
                {
                    ...
                    WriteLog(ex, "GetKeyValues(commandText=" + commandText + ",parameters=" + strParameters + ")", strOperator);
                    return null;
                }
            }
            else
        ...
        public bool BatchTable(DataTable dt, string sqlStr, string m_PrimaryKeys)
        {
            ...
            {
                WriteLog(ex, "BatchTable(DataTable dt, string sqlStr, string m_PrimaryKey) sqlStr=" + sqlStr + " m_PrimaryKeys=" + m_PrimaryKeys, strOperator);
                return false;
            }
        }
        /// <summary>
        ...
        public bool BatchInsertDataTable(DataTable table)
        {
            if (table is DataTable)
            {
                ...
                {
                    WriteLog(ex, "BatchInsertDataTable(table)"+table.TableName, strOperator);
                    return false;
                }
            }
            else
            ...
            if (table is DataTable)
            {
                ...
                try
                {
                    ...
                    if(!string.IsNullOrEmpty(updateFields.Trim()))
                    {
                        ...
                        {
                            if (!string.IsNullOrWhiteSpace(arrUpdate[i]))
                ...
                {
                    WriteLog(ex, "public bool BatchInsertAndUpdateDataTable(DataTable table,string condition,string updateFields,string incrementPrimaryKey)" + table.TableName, strOperator);
                    return false;
                }
                finally
                {
        ...
        public bool BatchInsertDataTable(DataRow[] dataRows, string tableName)
        {
            ...
            {
                WriteLog(ex, "BatchInsertDataTable(dataRows," + tableName + ")", strOperator);
                return false;
            }
            finally
            {
