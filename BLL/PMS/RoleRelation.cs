...
namespace BLL.PMS
{
    ...
    {
        private readonly IDAL.PMS.IRoleRelation dal = DALFactory.DALFactory.GetInstance().GetRoleRelation();
        /// <summary>
        /// 查询RoleRelation
        /// </summary>
        ...
        {
            return dal.SearchByRoleId(m_RoleId);
        }
        /// <summary>
        /// 增加RoleRelation
        /// </summary>
        ...
        {
            return dal.Update(m_RoleRelation);
        }
        ...
        {
            return dal.IsExist(m_RoleID, m_EmployeeID);
        }
        /// <summary>
        ...
        {
            return dal.GetFieldValue(m_EmployeeID, m_FieldName);
        }
        /// <summary>
        /// 获得角色关系表中的m_FieldName的值
        /// </summary>
