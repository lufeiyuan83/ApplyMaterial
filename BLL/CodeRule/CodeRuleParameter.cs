...
namespace BLL.CodeRule
{
    ...
    {
        private readonly IDAL.CodeRule.ICodeRuleParameter dal = DALFactory.DALFactory.GetInstance().GetCodeRuleParameter();
        /// <summary>
        /// 查询编码原则参数信息
        /// </summary>
        /// <returns></returns>
        ...
        {
            return dal.Search(m_CodeRuleId);
        }
        /// <summary>
        /// 增加编码原则参数信息
        /// </summary>
        ...
        {
            return dal.Add(m_CodeRuleParameter);
        }
        /// <summary>
        /// 更新编码原则参数信息
        /// <param name="m_CodeRuleParameter">编码原则参数信息</param>
        ...
        {
            return dal.Update(m_CodeRuleParameter);
        }
        /// <summary>
        /// 删除编码原则参数信息
        /// </summary>
        ...
        {
            return dal.GetMaxSortNo(m_CodeRuleId, m_ParentId, m_IsSubNodeSortNo, m_IsTopNode);
        }
        /// <summary>
        /// 是否已经存在该编码参数信息
        /// </summary>
        ...
        {
            return dal.IsExist(m_CodeRuleId, m_ParameterCode);
        }
        /// <summary>
        /// 是否已经存在该编码参数信息
        /// </summary>
        ...
        {
            return dal.IsExist(m_CodeRuleId,m_ParentId, m_ParameterCode);
        }
    }
}
