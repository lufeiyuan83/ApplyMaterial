...
namespace BLL.PLM
{
    ...
    {
        private readonly IDAL.PLM.IFlowInstance dal = DALFactory.DALFactory.GetInstance().GetFlowInstance();
        ...
        {
            return dal.GetCurrentWorkFlow(m_FlowName, m_Approver);
        }
        /// <summary>
        /// 获得当前的工作流
        /// </summary>
        ...
        {
            return dal.GetCurrentWorkFlow(m_FlowName, m_FormID,m_Approver);
        }
        /// <summary>
        /// 获得当前的工作流
        /// </summary>
        ...
        {
            return dal.GetCurrentWorkFlow(m_FlowName, m_FormID[0], m_Approver);
        }
        /// <summary>
        /// 是否已经审批完成
        /// </summary>
