...
namespace SQLHelp
{
    public class DataAccess : IDisposable
    {
        ...
        private string strOperator = "DataAccess";
        ...
        public DataAccess()
        {
            //connectionString = @"Data Source=10.148.15.80;Initial Catalog=Auth;Persist Security Info=True;User ID=sa;Password=FIS232311109Qq";
            connectionString = @"Data Source=.;Initial Catalog=Auth;Persist Security Info=True;User ID=sa;Password=FIS232311109Qq";
