...
namespace IDAL.Tenement
{
    public interface ILogin
    {
        ...
        /// <returns>返回Login</returns>
        Model.Tenement.Login Select(string m_UserName);
        /// <summary>
        /// 增加Login
        /// </summary>
        /// <param name="m_Login">Login</param>
        /// <returns>返回增加结果</returns>
        bool Add(Model.Tenement.Login m_Login);
        /// <summary>
        /// 更新Login
        /// </summary>
        /// <param name="m_Login">Login</param>
        /// <returns>返回增加结果</returns>
        bool Update(Model.Tenement.Login m_Login);
        /// <summary>
        /// 更新Login
        /// </summary>
        /// <param name="m_Login">Login</param>
        ...
        /// <returns>返回增加结果</returns>
        bool Update(Model.Tenement.Login m_Login, string m_OldUserName);
        /// <summary>
        /// 删除Login
        /// </summary>
        /// <param name="m_UserName">UserName</param>
