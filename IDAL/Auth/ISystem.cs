...
namespace IDAL.Auth
{
    public interface ISystem
    {
        ...
        /// <returns>System</returns>
        Model.Auth.System Select(long m_id);
        /// <summary>
        /// 查询System
        /// </summary>
        /// <param name="m_id">主键</param>
        ...
        /// <returns>System</returns>
        Model.Auth.System Select(string m_SystemCode);
        /// <summary>
        /// 查询单条System
        /// </summary>
        /// <param name="m_SystemCode">系统代码</param>
        ...
        /// <returns>System</returns>
        Model.Auth.System Select(string m_SystemCode, string m_SystemName);
        /// <summary>
        /// 查询System
        /// </summary>
        /// <param name="m_SystemCode">系统代码</param>
        ...
        bool Add(Model.Auth.System m_System);
        /// <summary>
        /// 更新System
        /// </summary>
        /// <param name="m_System">System</param>
        /// <returns>返回更新结果</returns>
        bool Update(Model.Auth.System m_System);
        /// <summary>
        /// 删除System
        /// </summary>
        /// <param name="m_id">主键</param>
