...
namespace IDAL.PLM
{
    public interface IMapping
    {
        ...
        /// <param name="m_MapCode">MapCode</param>
        /// <returns>Mapping</returns>
        DataSet Select(string m_MapGroup, List<string> m_MapCode);
        /// <summary>
        /// 查询Mapping
        /// </summary>
        /// <param name="m_MapGroup">MapGroup</param>
        ...
        /// <returns>Mapping</returns>
        DataTable Search(string m_MapGroup, string m_MappingName1, string m_MappingType1);
        /// <summary>
        /// 查询Mapping的扩展子项
        /// </summary>
        ...
        /// <param name="m_MappingID">MappingID</param>
        /// <returns>Mapping</returns>
        Model.PLM.Mapping Select(long m_MappingID);
    }
}
