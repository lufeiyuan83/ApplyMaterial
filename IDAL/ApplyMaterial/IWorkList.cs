...
namespace IDAL.ApplyMaterial
{
    public interface IWorkList
    {
        ...
        /// </summary>
        /// <returns></returns>
        Model.ApplyMaterial.WorkList Select(long m_id);
        /// <summary>
        /// 查询该操作员的工作列表
        ...
        /// </summary>
        /// <returns></returns>
        Model.ApplyMaterial.WorkList Search(string m_SystemCode, string m_TableName, string m_FormID);
        /// <summary>
        /// 记录工作列表
        /// <param name="m_WorkList">工作列表</param>
        /// </summary>
        /// <returns></returns>
        bool Add(Model.ApplyMaterial.WorkList m_WorkList);
        /// <summary>
        /// 记录工作列表
        /// <param name="m_WorkList">工作列表</param>
        /// </summary>
        /// <returns></returns>
        bool Add(List<Model.ApplyMaterial.WorkList> m_WorkList);
        /// <summary>
        /// 更新工作列表的状态
        /// <param name="m_WorkList">代办列表</param>
        /// </summary>
        /// <returns></returns>
        bool Update(Model.ApplyMaterial.WorkList m_WorkList);
        /// <summary>
        /// 更新工作列表的状态
