...
namespace IDAL.ApplyMaterial
{
    ...
    {        
        ...
        /// </summary>
        /// <returns></returns>
        Model.ApplyMaterial.FlowInstance Select(long m_id);
        /// <summary>
        /// 查詢該表單的工作流信息
        /// </summary>
        ...
        /// <returns></returns>
        DataTable GetCurrentWorkFlow(string m_FlowName, string m_OperatorID);
        /// <summary>
        /// 獲得當前的工作流
        /// </summary>
        /// <param name="m_FlowName">工作流</param>
        ...
        /// <param name="m_OperatorID">可審批人</param>
        /// <returns></returns>
        DataTable GetCurrentWorkFlow(string m_FlowName, string m_FormID, string m_OperatorID);
        /// <summary>
        /// 是否已经审批完成
        /// </summary>
